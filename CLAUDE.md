...
This is a **dual-process** local AI agent system. `coderook-core` is a persistent daemon; `coderook` and `coderook-tui` are clients that connect to it over a Unix domain socket.
