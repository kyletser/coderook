...
- 使用问题：先阅读 [README.md](README.md)、[用户指南](docs/USER_GUIDE.md) 和
  [运行手册](RUNBOOK.md)。
...
- 想贡献代码：从 [Contributor Tasks](docs/CONTRIBUTOR_TASKS.md) 选择边界明确的 `READY` 项；普通
...
项目不承诺响应 SLA，维护责任与权限边界见[维护者说明](docs/MAINTAINERS.md)。
