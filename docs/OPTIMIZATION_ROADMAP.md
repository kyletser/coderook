...
**阶段 1 验收**：仓库放一个 AGENTS.md 立即生效；能搜索"最新 pydantic v2 变更"并引用网页内容；贴一张报错截图让 Agent 分析；TypeScript 项目编辑后有实时红肿诊断；连续 Bash 调用 `cd` 状态保持。
