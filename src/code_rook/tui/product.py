...
_TEXT: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "plan_review.approve_detail": "实施计划内修改；命令仍按需确认",
        ...
        "permission.choice.session_allow": "本会话允许",
        ...
        "permission.choice.session_detail": "当前会话后续同类操作不再询问",
        ...
        "permission.decision.session_allow": "本会话允许",
        ...
        "app.session.imported": "已导入 {count} 条会话消息",
        ...
        "cmd.session.importing": "正在导入会话",
        "cmd.session.import_usage": "用法：/import <CodeRook JSON 或 Pi JSONL 文件>",
        ...
        "help.model": "打开模型选择器",
        "help.thinking": "循环思考强度 off → low → medium → high",
        "help.details": "展开或收起推理、工具步骤与完整输出",
        "help.editor": "在系统编辑器中修改当前输入，保存后回填",
        "help.paste_image": "从剪贴板附加截图",
        "help.follow_up": "运行中排队为下一条后续消息",
        "help.dequeue": "把尚未执行的后续消息取回输入框",
        "app.queue.restore_empty": "没有可取回的后续消息",
        "app.queue.restored": "已取回 {count} 条后续消息",
        "app.editor.unavailable": "当前输入框不可编辑",
        "app.editor.failed": "无法打开外部编辑器：{error}",
        "app.editor.loaded": "已从外部编辑器载入输入",
        ...
        "attachments.clipboard_empty": "剪贴板中没有可附加的图片",
        "attachments.clipboard_source": "剪贴板截图",
        ...
        "command.hotkeys": "显示键位与全部命令（/help 的别名）",
        "command.quit": "退出 CodeRook",
        "command.sessions": "打开会话选择器（输入即过滤）",
        "command.resume": "打开会话选择器（/sessions 的别名）",
        "command.session": "查看当前会话、模型与用量",
        "command.new": "新建会话",
        "command.rename": "重命名当前会话：/rename <标题>",
        "command.name": "重命名当前会话：/name <标题>",
        "command.fork": "选择历史节点并从这里创建分支",
        "command.clone": "复制当前完整分支：/clone [标题]",
        "command.tree": "选择历史节点并从这里继续",
        "command.reload": "重新加载扩展、提示模板与 Skills",
        "command.preset": "通过分支切换冻结的 Agent Preset",
        "command.export": "导出当前会话：/export [md|json|html]",
        "command.import": "导入 CodeRook JSON 或兼容 JSONL 会话",
        "command.delete": "删除当前会话（需 --yes 确认）",
        "command.provider": "查看或切换 Provider route",
        "command.model": "查看或切换模型",
        "command.thinking": "查看或切换当前会话的思考强度",
        ...
        "command.delivery": "配置纠偏与后续消息的交付方式",
    ...
    "en": {
        ...
        "shell.banner_connecting_title": "Connecting to local Core",
        ...
        "shell.user_shell_running": "Command running · Enter queues · Ctrl+C cancel",
        ...
        "plan_review.approve_detail": "Apply planned edits; commands still ask when needed",
        ...
        "permission.choice.session_allow": "Allow for session",
        ...
        "permission.choice.session_detail": "allow similar actions in this session",
        ...
        "permission.decision.session_allow": "allowed for this session",
        ...
        "app.session.imported": "Imported {count} session messages",
        ...
        "cmd.session.importing": "Importing session",
        "cmd.session.import_usage": "Usage: /import <CodeRook JSON or Pi JSONL file>",
        ...
        "help.enter": "Send; Shift+Enter or Ctrl+J inserts a newline",
        ...
        "help.abort": "Cancel the active task immediately and restore pending messages",
        ...
        "help.model": "Open the model picker",
        "help.thinking": "Cycle thinking off → low → medium → high",
        "help.details": "Expand or collapse reasoning, tool steps, and full output",
        "help.editor": "Edit the current composer in your system editor",
        "help.paste_image": "attach a screenshot from the clipboard",
        "help.follow_up": "Queue a follow-up while the agent is running",
        "help.dequeue": "Restore unprocessed follow-ups to the composer",
        "app.queue.restore_empty": "No queued follow-up messages to restore",
        "app.queue.restored": "Restored {count} queued follow-up message(s)",
        "app.editor.unavailable": "The composer is not editable right now",
        "app.editor.failed": "Could not open the external editor: {error}",
        "app.editor.loaded": "Loaded input from the external editor",
        ...
        "attachments.clipboard_empty": "The clipboard does not contain an image",
        "attachments.clipboard_source": "clipboard image",
        ...
        "command.hotkeys": "Show shortcuts and commands (alias for /help)",
        "command.quit": "Quit CodeRook",
        "command.sessions": "Open the searchable session picker",
        "command.resume": "Open the session picker (alias for /sessions)",
        ...
        "command.name": "Rename the current session with /name",
        "command.fork": "Choose a history point and fork from there",
        "command.clone": "Clone the complete current branch: /clone [title]",
        "command.tree": "Choose a history point and continue from there",
        "command.reload": "Reload extensions, prompt templates, and Skills",
        "command.preset": "Switch the frozen Agent Preset through a fork",
        "command.export": "Export the current session",
        "command.import": "Import a CodeRook JSON or compatible JSONL session",
        ...
        "command.thinking": "Inspect or switch the session thinking level",
        ...
        "command.delivery": "Configure steering and follow-up message delivery",
