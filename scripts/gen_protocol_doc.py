...
def generate() -> str:
    ...
    sections = [
        ...
        "\n",
        _model_section("SessionTasksCommand", SessionTasksCommand),
        "\n",
        _model_section("SessionTasksResult", SessionTasksResult),
        "\n",
        _model_section("WorkerListCommand", WorkerListCommand),
        "\n",
        _model_section("WorkerListResult", WorkerListResult),
        "\n",
        _model_section("WorkflowStartCommand", WorkflowStartCommand),
        "\n",
        _model_section("WorkflowStartResult", WorkflowStartResult),
        "\n",
        _model_section("WorkflowListCommand", WorkflowListCommand),
        "\n",
        _model_section("WorkflowListResult", WorkflowListResult),
        "\n",
        _model_section("WorkflowGetCommand", WorkflowGetCommand),
        "\n",
        _model_section("WorkflowGetResult", WorkflowGetResult),
        "\n",
        _model_section("WorkspaceDiffCommand", WorkspaceDiffCommand),
        "\n",
        _model_section("WorkspaceDiffResult", WorkspaceDiffResult),
        "\n",
        _model_section("SessionCheckpointsCommand", SessionCheckpointsCommand),
        "\n",
        _model_section("SessionCheckpointsResult", SessionCheckpointsResult),
        "\n",
        _model_section("SessionRewindCommand", SessionRewindCommand),
        "\n",
        _model_section("SessionRewindResult", SessionRewindResult),
        "\n",
        _model_section("SessionContextCommand", SessionContextCommand),
        "\n",
        _model_section("SessionContextResult", SessionContextResult),
        "\n",
        _model_section("TurnInspectCommand", TurnInspectCommand),
        "\n",
        _model_section("TurnInspectResult", TurnInspectResult),
        "\n## Server Push\n\n",
        ...
        "\n",
        _model_section("HookExecutedEvent", HookExecutedEvent),
        "\n## Run Events\n\n",
        ...
        "\n",
        _model_section("AgentStuckEvent", AgentStuckEvent),
        "\n",
        ...
        "\n",
        _model_section("LlmRouteSelectedEvent", LlmRouteSelectedEvent),
        "\n",
        _model_section("LlmTokenEvent", LlmTokenEvent,
            {"type": "llm.token", "run_id": run_id, "token": "The ", "ts": ts}),
        "\n",
        _model_section("LlmReasoningEvent", LlmReasoningEvent,
            {"type": "llm.reasoning", "run_id": run_id,
             "content": "I should inspect the project first.", "ts": ts}),
        "\n",
        ...
        "\n",
        _model_section("LlmRetryEvent", LlmRetryEvent),
        "\n",
        _model_section("ContextPrefixFingerprintEvent", ContextPrefixFingerprintEvent),
        "\n",
        _model_section("ContextBudgetEvent", ContextBudgetEvent),
        "\n",
        _model_section("ContextWorkingSetEvent", ContextWorkingSetEvent),
        "\n",
        _model_section("LspDiagnosticsEvent", LspDiagnosticsEvent),
        "\n",
        _model_section("LogLineEvent", LogLineEvent,
            {"type": "log.line", "run_id": run_id, "level": "INFO",
             "source": "code_rook.core.loop", "message": "step 1 started", "ts": ts}),
        "\n## Session Events\n\n",
