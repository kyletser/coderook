...
[开源补全计划](docs/OPEN_SOURCE_COMPLETION_PLAN.md)和
[发布评分卡](docs/RELEASE_SCORECARD.md)为准；Issue 或外部贡献不会自动改变发布结论。
...
想贡献一个边界明确的小改动，请从
[Contributor Tasks](docs/CONTRIBUTOR_TASKS.md)选择 `READY` 项并按模板认领；大型方向先开 Feature Request。
